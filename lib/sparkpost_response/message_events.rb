  ...
  module MessageEvents
    ...
    class << self
      ...
      def messages_event(options = {})
        bounce_classify = options[:classify_bounces] ? options.delete(:classify_bounces) : false
        process_message_event(bounce_classify, process_options(options))
      end
